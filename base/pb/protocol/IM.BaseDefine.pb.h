...
constexpr LoginCmdID LoginCmdID_MIN = CID_LOGIN_DEFAULT;
...
constexpr BuddyListCmdID BuddyListCmdID_MIN = CID_BUDDY_DEFAULT;
...
constexpr GroupCmdID GroupCmdID_MIN = CID_GROUP_DEFAULT;
...
constexpr FileCmdID FileCmdID_MIN = CID_FILE_DEFAULT;
...
constexpr SwitchServiceCmdID SwitchServiceCmdID_MIN = CID_SWITCH_DEFAULT;
...
constexpr OtherCmdID OtherCmdID_MIN = CID_OTHER_DEFAULT;
...
constexpr KickReasonType KickReasonType_MIN = KICK_REASON_DEFAULT;
...
constexpr OnlineListType OnlineListType_MIN = ONLINE_LIST_TYPE_DEFAULT;
...
constexpr GroupType GroupType_MIN = GROUP_TYPE_DEFAULT;
...
constexpr GroupModifyType GroupModifyType_MIN = GROUP_MODIFY_DEFAULT;
...
enum TransferFileType : int {
  ...
  FILE_TYPE_ONLINE = 1,
  FILE_TYPE_OFFLINE = 2,
  TransferFileType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  TransferFileType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool TransferFileType_IsValid(int value);
constexpr TransferFileType TransferFileType_MIN = FILE_TYPE_DEFAULT;
...
constexpr ClientFileRole ClientFileRole_MIN = CLIENT_DEFAULT;
